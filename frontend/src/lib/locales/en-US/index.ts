export const enUS = {
  ...
  navigation: {
    ...
    ask: "Ask",
    admin: "Admin",
    oracleSettings: "Oracle HR DB Settings",
  },
  notebooks: {
    title: "Notebooks",
    newNotebook: "New Notebook",
  ...
  admin: {
    oracleSettings: {
      pageTitle: "Oracle HR DB Settings",
      loading: "Loading settings...",
      cardTitle: "Connection Settings",
      cardDesc: "Enter Oracle HR database connection information. Password is not displayed after saving.",
      enabledLabel: "Enable Oracle HR Authentication",
      enabledDesc: "When disabled, only system accounts can log in",
      dsnLabel: "DSN",
      ...
      poolMinLabel: "Min Pool Size",
      poolMaxLabel: "Max Pool Size",
      userViewLabel: "HR User View",
      userViewDesc: "Oracle view/table name for employee authentication (SCHEMA.VIEW_NAME format)",
      testing: "Testing...",
      testConnection: "Test Connection",
      loadFailed: "Failed to load Oracle settings.",
      saveSuccess: "Oracle settings saved.",
